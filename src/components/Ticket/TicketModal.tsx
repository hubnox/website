      ...
      {!isDownloadOpen && (
        <div className="relative z-50 w-[596px] bg-[#1B2334] rounded-2xl p-5 flex flex-col gap-[30px]">
          <div className="relative w-[556px] h-[44px] flex items-center justify-between">
            ...
            <h2 className="absolute left-1/2 -translate-x-1/2 font-bold text-[20px] text-white">
              Get tickets {step}/3
            </h2>
          ...
          <div className="flex gap-4">
            ...
            <div className="flex flex-col justify-between w-[468px] h-20 gap-2">
              <div className="flex flex-col gap-2">
                <span className="font-bold text-[20px] text-white">{title}</span>
                <span className="text-[16px] text-gray-300">{date}</span>
              </div>
              <span className="text-[14px] text-[#D0D5DD]">{location}</span>
            </div>
          </div>
